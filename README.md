...
I spend more time in the terminal than doing anything else.

Honestly I like things that are simple, straightforward, and that work.
> If it does what it has to do and does it right, that's already ~fucking~ awesome.
...
- Version control: Git (this is a jk, of course)
